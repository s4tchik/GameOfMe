...
public class RoomFirstDungeonGenerator : SimpleRandomWalkDungeonGenerator
{
    ...
    private void Start()
    {
        GenerateDungeon(); // Запуск генерации карты при старте сцены
    }
    ...
    // Метод для загрузки сцены с генерацией
    public void LoadDungeonScene()
    {
        SceneManager.LoadScene("EasyGame 1");
    }

    // Метод для запуска генерации через UI-кнопку
